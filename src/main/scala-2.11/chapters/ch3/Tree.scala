...
object Tree {
  ...
  /**
    * This implementation of books author is smarter but serves the same purpose
    * I think the only thing that can matter that my implementation needs an additional call of a depth method
    * But less code - more readable in this case.
    */
